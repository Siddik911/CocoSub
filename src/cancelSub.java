   ...
   JPanel panel1,panel2;
    ...
    public cancelSub() {
        ...
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
         ...
         f1 = new Font("Sans Serif", Font.BOLD, 24);
        ...
        this.add(panel2);
         ...
         l4 = new JLabel("Sorry to say you Good Bye!");
        ...
        panel2.add(l4);
         ...
         l1 = new JLabel("Select your Cancellation Reason");
        ...
        panel2.add(l1);
         ...
         l2 = new JLabel("Share your valuable Feedback");
        ...
        panel1.add(b1);
         ...
         b2=new JButton("Cancel Subscription");
